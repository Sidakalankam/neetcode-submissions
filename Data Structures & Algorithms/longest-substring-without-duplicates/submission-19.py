class Solution:
    def lengthOfLongestSubstring(self, s: str) -> int:
        ...
        4. we increment the current count by 1
        5. if r reaches a repeated character, 
           1. we set the max count to the max of the current max and the current count
           2. we move l by 1 until the window doesn't repeat chars and delete l from the set and we continue until r isn't in the set
